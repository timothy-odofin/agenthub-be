...
class TestChatServiceIntegration:
    ...
    async def test_chat_with_structured_agent_response(self):
        ...
        with patch("app.services.chat_service.ChatService") as MockChatService:
            ...
            assert chat_output.tools_invoked == [
    ...
    async def test_agent_thinking_workflow(self):
        ...
        thinking_response = {
            ...
            "tool_parameters": {"config_type": "rate_limits", "user_tier": "standard"},
            "risk_assessment": "low",
...
class TestHealthCheckIntegration:
    ...
    async def test_system_diagnostics_analysis(self):
        ...
        diagnostics_response = {
            ...
            "bottlenecks": ["celery_queue_processing", "database_query_optimization"],
...
class TestRealWorldScenarios:
    ...
    def test_backwards_compatibility(self):
        ...
        old_response = LLMResponse(
            content="Traditional response text", usage={"tokens": 100}
        )
