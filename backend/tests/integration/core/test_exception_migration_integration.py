...
class TestAuthenticationDependencies:
    ...
    async def test_get_current_user_invalid_token(self):
        ...
        with patch(
            "app.core.security.dependencies.token_manager"
    ...
    async def test_get_current_user_user_not_found_in_db(self):
        ...
        with (
            patch("app.core.security.dependencies.token_manager") as mock_token_manager,
...
class TestErrorResponseFormat:
    ...
    def test_authentication_error_response_format(self):
        ...
        exc = AuthenticationError(message="Invalid token", request_id="req_format_test")
...
class TestRequestIDTracking:
    ...
    def test_request_id_from_middleware(self):
        ...
        exc = AuthenticationError(message="Test", request_id=request.state.request_id)
    ...
    def test_request_id_in_error_response(self):
        ...
        exceptions = [
            ...
            ServiceUnavailableError(
                service_name="test", message="Service error", request_id=request_id
            ),
