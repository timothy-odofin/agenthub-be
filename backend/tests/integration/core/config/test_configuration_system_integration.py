...
class TestSettings:
    ...
    def test_yaml_loader_basic_functionality(self):
        ...
        test_data = {
            ...
            "vector_db": {"provider": "qdrant", "collection_name": "test_collection"},
        }
    ...
    def test_yaml_loader_multiple_files_merge(self):
        ...
        config2_path = self._create_test_config_file(
            config2_data, self.test_nested_config_path
        )

        # Test merging
        merged_data = YamlLoader.load_multiple_files(
            config1_path, config2_path, merge=True
        )
    ...
    def test_dynamic_config_get_method(self):
        ...
        test_data = {
            "llm": {"provider": "openai", "nested": {"deep": {"value": "found"}}}
        }
    ...
    def test_defaults_manager_with_test_config(self):
        ...
        test_defaults = {
            ...
            "database": {"provider": "test_database"},
        }
        ...
        try:
            ...
            def mock_load_defaults(self):
                try:
                    defaults_data = YamlLoader.load_file(
                        str(test_defaults_file), raise_on_missing=False
                    )
    ...
    def test_defaults_manager_section_methods(self):
        ...
        # Create test config
        test_data = {"llm": {"provider": "openai"}, "vector_db": {"provider": "qdrant"}}
    ...
    def test_defaults_manager_get_value_method(self):
        ...
        test_data = {"llm": {"provider": "openai", "config": {"temperature": 0.7}}}
