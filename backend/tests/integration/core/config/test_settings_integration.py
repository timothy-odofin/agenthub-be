...
class TestSettings:
    ...
    def _create_test_profile_file(self, profile_name: str, config_data: dict):
        ...
        file_path = os.path.join(
            self.temp_resources_dir, f"application-{profile_name}.yaml"
        )
    ...
    def test_profile_discovery_and_loading(self):
        ...
        vector_config = {"provider": "qdrant", "collection_name": "test_collection"}
    ...
    def test_yaml_loader_profile_integration(self):
        ...
        llm_file = self._create_test_profile_file(
            "llm", {"provider": "anthropic", "model": "claude-3"}
        )

        db_file = self._create_test_profile_file(
            "db", {"provider": "postgresql", "host": "localhost"}
        )
    ...
    def test_dynamic_config_with_profiles(self):
        ...
        profile_data = {
            ...
            "features": {"user_management": True, "analytics": False},
        }
    ...
    def test_settings_get_value_method(self):
        ...
        # Create test profile
        self._create_test_profile_file(
            "config",
            {
                "server": {
                    "host": "localhost",
    ...
    def test_integration_with_existing_config_system(self):
        ...
        from app.core.config import app_config, config, database_config, vector_config
    ...
    def test_nested_workflow_configurations(self):
        ...
        approval_config = {
            "approval": {
                ...
                "agent": {"type": "langchain", "implementation": "LangChainReactAgent"},
                "stages": {
        ...
        try:
            ...
            assert hasattr(
                settings, "workflows"
            ), "Nested 'workflows' attribute should be created"
            ...
            assert hasattr(
                workflows, "approval"
            ), "Should have 'approval' workflow config"
    ...
    def test_mixed_flat_and_nested_configurations(self):
        ...
        db_config = {"database": {"host": "localhost", "port": 5432, "name": "test_db"}}
        ...
        signup_config = {"signup": {"enabled": True, "timeout": 300}}
    ...
    def test_nested_configuration_error_handling(self):
        ...
        try:
            ...
            if hasattr(settings, "workflows"):
                ...
                assert not hasattr(
                    settings.workflows, "malformed"
                ), "Malformed config should not load"
