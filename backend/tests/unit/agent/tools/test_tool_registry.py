...
from app.agent.tools.base.registry import (
    ToolRegistry,
    _packages,
    _tools,
    is_tool_enabled,
...
def mock_settings():
    ...
    vector_config = MockConfig(
        enabled=True, retrieve_information=True, structured_mock_tool=True
    )

    disabled_config = MockConfig(enabled=False, some_tool=True)

    # Create tools configuration
    tools_config = MockConfig(
        jira=jira_config, vector=vector_config, disabled_category=disabled_config
    )
...
class TestToolConfiguration:
    ...
    def test_is_tool_enabled_with_enabled_category(
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_is_tool_enabled_with_disabled_individual_tool(
        self, mock_settings_obj, mock_settings
    ):
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_is_tool_enabled_with_disabled_category(
        self, mock_settings_obj, mock_settings
    ):
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_is_tool_enabled_with_nonexistent_category(
        self, mock_settings_obj, mock_settings
    ):
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_is_tool_enabled_with_nonexistent_tool(
        self, mock_settings_obj, mock_settings
    ):
...
class TestToolInstantiation:
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_get_instantiated_tools_all_categories(
        self, mock_settings_obj, mock_settings
    ):
        ...
        assert (
            "structured_mock_tool" in tool_names
        )  # vector.structured_mock_tool = True

    @patch("app.agent.tools.base.registry.settings")
    def test_get_instantiated_tools_specific_category(
        self, mock_settings_obj, mock_settings
    ):
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_get_instantiated_tools_handles_tool_without_get_tools(
        self, mock_settings_obj, mock_settings
    ):
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_get_instantiated_tools_handles_initialization_exception(
        self, mock_settings_obj, mock_settings
    ):
...
class TestToolRegistryIntegration:
    ...
    @patch("app.agent.tools.base.registry.settings")
    def test_disabled_category_filters_all_tools(
        self, mock_settings_obj, mock_settings
    ):
        ...
        disabled_category_tools = ToolRegistry.get_instantiated_tools(
