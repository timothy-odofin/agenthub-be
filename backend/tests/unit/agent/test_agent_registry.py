...
class MockAgent(BaseAgent):
    ...
    async def execute(self, query: str, context: AgentContext) -> AgentResponse:
        return AgentResponse(content="Mock response", status=AgentStatus.COMPLETED)
...
class TestAgentRegistry:
    ...
    def test_register_decorator_functionality(self):
        ...
        retrieved_class = AgentRegistry.get_agent_class(
    ...
    def test_register_override_warning(self):
        ...
        with patch("app.agent.base.agent_registry.logger.warning") as mock_warning:
            ...
            assert (
                "Overriding existing agent registration" in mock_warning.call_args[0][0]
            )
    ...
    def test_get_agent_class_not_registered_raises_value_error(self):
        ...
        assert (
            "No agent registered for type 'react' with framework 'langchain'"
            in error_message
        )
    ...
    def test_get_agents_by_framework(self):
        ...
        # Act
        langchain_agents = AgentRegistry.get_agents_by_framework(
    ...
    def test_get_agents_by_framework_no_matches(self):
        ...
        # Act
        langgraph_agents = AgentRegistry.get_agents_by_framework(
    ...
    def test_is_registered_true(self):
        ...
        # Act & Assert
        assert (
            AgentRegistry.is_registered(AgentType.REACT, AgentFramework.LANGCHAIN)
            is True
        )
    ...
    def test_clear_registry(self):
        ...
        assert not AgentRegistry.is_registered(
            AgentType.REACT, AgentFramework.LANGCHAIN
        )
        assert not AgentRegistry.is_registered(
...
class TestAgentRegistryEdgeCases:
    ...
    def test_registry_state_persistence_across_operations(self):
        ...
        is_registered_1 = AgentRegistry.is_registered(
            AgentType.REACT, AgentFramework.LANGCHAIN
        )
        agents_by_type = AgentRegistry.get_agents_by_type(AgentType.REACT)
        agents_by_framework = AgentRegistry.get_agents_by_framework(
            AgentFramework.LANGCHAIN
        )
        agents_list_2 = AgentRegistry.list_registered_agents()
        is_registered_2 = AgentRegistry.is_registered(
            AgentType.REACT, AgentFramework.LANGCHAIN
        )
    ...
    def test_decorator_returns_original_class(self):
        ...
        # Act
        decorated_class = AgentRegistry.register(
            AgentType.REACT, AgentFramework.LANGCHAIN
        )(OriginalAgent)
