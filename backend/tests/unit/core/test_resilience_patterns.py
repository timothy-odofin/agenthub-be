...
from app.core.exceptions import ServiceUnavailableError, ThirdPartyAPIError
from app.core.exceptions import TimeoutError as AppTimeoutError
from app.core.resilience import (  # Retry; Circuit Breaker; Timeout
...
class TestCircuitBreakerDecorator:
    ...
    def test_circuit_breaker_opens_after_failures(self):
        ...
        config = CircuitBreakerConfig(
            name="test_circuit_2", failure_threshold=3, recovery_timeout=60.0
        )
    ...
    def test_circuit_breaker_with_fallback(self):
        ...
        config = CircuitBreakerConfig(
            name="test_circuit_5", failure_threshold=2, fallback=fallback
        )
...
class TestAsyncCircuitBreaker:
    ...
    async def test_async_circuit_breaker_opens(self):
        ...
        config = CircuitBreakerConfig(name="test_async_circuit_2", failure_threshold=3)
...
class TestResiliencePatternIntegration:
    ...
    async def test_retry_with_circuit_breaker(self):
        ...
        cb_config = CircuitBreakerConfig(name="test_integration_1", failure_threshold=5)
