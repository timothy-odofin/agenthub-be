...
class TestExceptionFormats:
    ...
    def test_authentication_error_format(self):
        ...
        exc = AuthenticationError(message="Invalid token", request_id="req_test_001")
    ...
    def test_validation_error_format(self):
        ...
        exc = ValidationError(
            message="Invalid email format", field="email", request_id="req_test_002"
        )
    ...
    def test_not_found_error_format(self):
        ...
        exc = NotFoundError(
            resource_type="user", resource_id="12345", request_id="req_test_005"
        )
...
class TestRequestIDPropagation:
    ...
    def test_request_id_in_exception(self):
        ...
        exc = ValidationError(message="Test error", request_id=request_id)
    ...
    def test_request_id_in_log_context(self):
        ...
        exc = AuthenticationError(message="Test auth error", request_id=request_id)
...
class TestLogContext:
    ...
    def test_log_context_uses_error_message(self):
        ...
        exc = ValidationError(message="Test message", request_id="req_test")
    ...
    def test_log_context_includes_internal_details(self):
        ...
        internal_data = {"database": "test_db", "query": "SELECT * FROM users"}
    ...
    def test_log_context_no_reserved_fields(self):
        ...
        exc = AuthenticationError(message="Test", request_id="req_test")
        ...
        for field in reserved_fields:
            assert (
                field not in log_context
            ), f"Reserved field '{field}' found in log context"
...
class TestSecurityImplications:
    ...
    def test_sensitive_data_not_in_api_response(self):
        ...
        exc = InternalError(
            message="Connection failed", internal_details=sensitive_data
        )
...
class TestDetailsAndInternalDetails:
    ...
    def test_internal_details_not_in_api_response(self):
        ...
        exc = InternalError(message="Error", internal_details={"secret": "value"})
    ...
    def test_internal_details_in_log_context(self):
        ...
        exc = InternalError(message="Error", internal_details=internal)
