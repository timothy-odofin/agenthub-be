...
class TestAddCapability:
    ...
    def test_add_capability_without_display_config(self):
        ...
        capabilities.add_capability(category="test", name="basic_tool", enabled=True)
    ...
    def test_add_capability_with_optional_color(self):
        ...
        capabilities.add_capability(
            ...
            name="colored_tool",
            enabled=True,
            display_config={"title": "Colored Tool", "color": "#FF5733"},
        )
...
class TestClearCapabilities:
    ...
    def test_clear_removes_all(self):
        ...
        for i in range(5):
            capabilities.add_capability(
                f"cat{i}", f"tool{i}", True, {"title": f"Test {i}"}
            )
