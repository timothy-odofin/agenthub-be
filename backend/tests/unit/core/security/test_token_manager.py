...
from src.app.core.security.token_manager import TokenManager, token_manager
...
class TestAccessTokenCreation:
    ...
    def test_create_access_token_with_username(self):
        ...
        token = token_manager.create_access_token(
            user_id="user123", email="test@example.com", username="johndoe"
        )
...
class TestRefreshTokens:
    ...
    def test_verify_expired_refresh_token(self):
        ...
        token = token_manager.create_refresh_token(
            user_id="user123", expires_delta=timedelta(seconds=-1)
        )
...
class TestTokenIntegration:
    ...
    def test_token_contains_all_user_info(self):
        ...
        token = token_manager.create_access_token(
            ...
            username="johndoe",
            additional_claims={"firstname": "John", "lastname": "Doe", "role": "user"},
        )
