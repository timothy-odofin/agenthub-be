...
class TestSessionRepositoryRegistry:
    ...
    def test_register_repository_decorator(self):
        ...
        # Apply the decorator
        decorated_class = SessionRepositoryRegistry.register_repository(
        ...
        assert (
            SessionRepositoryRegistry._repositories[SessionRepositoryType.POSTGRES]
            is MockRepository
        )
        assert (
            decorated_class is MockRepository
    ...
    def test_register_multiple_repositories(self):
        ...
        SessionRepositoryRegistry.register_repository(SessionRepositoryType.MONGODB)(
            MongoRepo
        )
        ...
        assert (
            SessionRepositoryRegistry._repositories[SessionRepositoryType.MONGODB]
            is MongoRepo
        )
    ...
    def test_get_repository_class_success(self):
        ...
        retrieved_class = SessionRepositoryRegistry.get_repository_class(
            SessionRepositoryType.POSTGRES
        )
    ...
    def test_get_repository_class_not_found(self):
        ...
        with pytest.raises(ValueError) as exc_info:
            SessionRepositoryRegistry.get_repository_class(
                SessionRepositoryType.POSTGRES
            )

        assert "Session repository 'SessionRepositoryType.POSTGRES' not found" in str(
            exc_info.value
        )
    ...
    def test_list_repositories(self):
        ...
        SessionRepositoryRegistry.register_repository(SessionRepositoryType.REDIS)(
            RedisRepo
        )
...
class TestSessionRepositoryFactory:
    ...
    @patch(
        "app.sessions.repositories.session_repository_factory.SessionRepositoryRegistry.get_repository_class"
    )
    def test_create_repository_success(self, mock_get_class):
        ...
        # Create repository
        result = SessionRepositoryFactory.create_repository(
            SessionRepositoryType.POSTGRES, test_param="test_value"
        )
    ...
    def test_create_repository_with_kwargs(self, mock_get_class):
        ...
        result = SessionRepositoryFactory.create_repository(
            SessionRepositoryType.MONGODB, **kwargs
        )
    ...
    @patch(
        "app.sessions.repositories.session_repository_factory.SessionRepositoryFactory.create_repository"
    )
    ...
    def test_create_repository_integration(self):
        ...
        repo = SessionRepositoryFactory.create_repository(
            SessionRepositoryType.POSTGRES, test_param="integration_test"
        )
...
class TestSessionRepositoryFactoryErrorHandling:
    ...
    def test_registry_with_invalid_repository_class(self):
        ...
        decorator = SessionRepositoryRegistry.register_repository(
            SessionRepositoryType.POSTGRES
        )
