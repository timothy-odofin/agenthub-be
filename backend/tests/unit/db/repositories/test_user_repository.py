...
class TestUserRepository:
    ...
    async def test_create_user_success(
        self, repository, mock_collection, sample_user_data
    ):
    ...
    async def test_get_user_by_email_found(
        self, repository, mock_collection, sample_user_dict
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_user_by_username_normalizes_input(
        self, repository, mock_collection, sample_user_dict
    ):
    ...
    async def test_user_exists_both(self, repository, mock_collection):
        ...
        result = await repository.user_exists(
    ...
    @pytest.mark.asyncio
    async def test_update_user_adds_updated_at(
        self, repository, mock_collection, sample_user_dict
    ):
