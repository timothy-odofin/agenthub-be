...
class TestConfluenceServiceArchitecture:
    ...
    def test_singleton_pattern_implementation(self):
        ...
        with patch(
            "app.services.external.confluence_service.ConfluenceService._ConfluenceService__init_client"
        ):
...
class TestConfluenceServiceSpaceListing:
    ...
    def test_list_confluence_spaces_specific_keys_success(self):
        ...
        with patch(
            ...
            mock_confluence.get_space.assert_any_call(
                "SPACE1", expand="description.plain,homepage"
            )
            mock_confluence.get_space.assert_any_call(
                "SPACE2", expand="description.plain,homepage"
            )
    ...
    def test_list_confluence_spaces_specific_keys_with_missing(self):
        ...
        with patch(
            ...
            with patch(
                "app.services.external.confluence_service.logger"
            ) as mock_logger:
...
class TestConfluenceServicePageOperations:
    ...
    def test_list_confluence_pages_in_space_multiple_pages(self):
        ...
        with patch(
            ...
            second_page = {"results": [{"id": "page3"}], "size": 1}  # Last page

            mock_confluence.get_all_pages_from_space_raw.side_effect = [
                first_page,
                second_page,
            ]
    ...
    def test_extract_content_from_page_with_ancestors(self):
        ...
        with patch(
            ...
            page_data = {
                ...
                "space": {"key": "SPACE1"},
                "ancestors": [{"title": "Parent Page"}, {"title": "Grandparent Page"}],
            }
            ...
            assert (
                metadata["breadcrumb"] == "Parent Page > Grandparent Page > Child Page"
            )
...
class TestConfluenceServiceUtilityMethods:
    ...
    def test_extract_keys_from_data(self):
        ...
        with patch(
            ...
            result = service._ConfluenceService__extract_keys_from_data(
                test_data, "key"
            )
    ...
    def test_get_page_meta_complete_data(self):
        ...
        with patch(
            ...
            page_data = {
                ...
                "version": {"when": "2023-01-01T10:00:00Z", "number": 5},
                "_links": {"webui": "/spaces/SPACE1/pages/123456"},
