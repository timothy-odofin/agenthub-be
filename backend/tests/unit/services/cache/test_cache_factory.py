...
class TestCacheFactory:
    ...
    def test_create_cache_with_explicit_type(self):
        ...
        cache = CacheFactory.create_cache(
            namespace="test", cache_type=CacheType.IN_MEMORY, default_ttl=600
        )
    ...
    def test_create_cache_with_default_ttl(self):
        ...
        cache = CacheFactory.create_cache(
            namespace="test", cache_type=CacheType.IN_MEMORY
        )
    ...
    def test_create_cache_with_custom_ttl(self):
        ...
        cache = CacheFactory.create_cache(
            namespace="custom_ttl", cache_type=CacheType.IN_MEMORY, default_ttl=1800
        )
    ...
    def test_create_cache_with_unregistered_type_raises_error(self):
        ...
        with pytest.raises(ValueError, match="not available"):
            CacheFactory.create_cache(namespace="test", cache_type=CacheType.MEMCACHED)

    def test_create_cache_with_invalid_namespace(self):
        """Test creating cache with empty namespace."""
        cache = CacheFactory.create_cache(namespace="", cache_type=CacheType.IN_MEMORY)
    ...
    def test_create_multiple_instances_with_different_namespaces(self):
        ...
        cache1 = CacheFactory.create_cache(
            namespace="namespace1", cache_type=CacheType.IN_MEMORY, default_ttl=300
        )

        cache2 = CacheFactory.create_cache(
            namespace="namespace2", cache_type=CacheType.IN_MEMORY, default_ttl=600
        )
    ...
    def test_create_cache_with_same_namespace_creates_new_instance(self):
        ...
        cache1 = CacheFactory.create_cache(
            namespace="duplicate", cache_type=CacheType.IN_MEMORY
        )
    ...
    def test_create_cache_with_none_cache_type_raises_error(self):
        ...
        with pytest.raises(ValueError, match="not available"):
            CacheFactory.create_cache(namespace="test", cache_type=None)

    def test_create_cache_with_zero_ttl(self):
        """Test creating cache with zero TTL."""
        cache = CacheFactory.create_cache(
            namespace="zero_ttl", cache_type=CacheType.IN_MEMORY, default_ttl=0
        )
    ...
    def test_create_cache_with_negative_ttl(self):
        ...
        cache = CacheFactory.create_cache(
            namespace="negative_ttl", cache_type=CacheType.IN_MEMORY, default_ttl=-1
        )
