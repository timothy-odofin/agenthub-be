...
class TestLLMOutputBase:
    ...
    def test_serialization(self):
        ...
        output = LLMOutputBase(success=True, confidence_score=0.95, reasoning="Test")
...
class TestAgentThinking:
    ...
    def test_confidence_validation(self):
        ...
        with pytest.raises(ValueError):
            AgentThinking(
                thought_process="Test", selected_action="respond", confidence_level=1.5
            )
...
class TestChatAgentResponse:
    ...
    def test_invalid_response_type(self):
        ...
        with pytest.raises(ValueError):
            ChatAgentResponse(response_text="Test", response_type="invalid_type")
...
class TestIngestionAnalysis:
    ...
    def test_quality_score_validation(self):
        ...
        with pytest.raises(ValueError):
            IngestionAnalysis(
                content_type="text", quality_score=1.5, document_summary="Test"
            )
    ...
    def test_invalid_content_type(self):
        ...
        with pytest.raises(ValueError):
            IngestionAnalysis(
                content_type="invalid_type", quality_score=0.8, document_summary="Test"
            )
...
class TestSessionAnalysis:
    ...
    def test_interaction_quality_validation(self):
        ...
        with pytest.raises(ValueError):
            SessionAnalysis(session_summary="Test", interaction_quality=1.5)
...
class TestStructuredLLMResponse:
    ...
    def test_get_structured_data(self):
        ...
        thinking = AgentThinking(
            thought_process="Test", selected_action="respond", confidence_level=0.8
        )
    ...
    def test_has_structured_output(self):
        ...
        response_no_struct = StructuredLLMResponse(
            content="Test", model_name="test", provider="test"
        )
...
class TestLLMResponseIntegration:
    ...
    def test_to_structured_response_with_json(self):
        ...
        llm_response = LLMResponse(
            content=json_content, usage={"tokens": 100}, metadata={"temp": 0.7}
        )
    ...
    def test_to_structured_response_with_plain_text(self):
        ...
        llm_response = LLMResponse(
            content="This is plain text response", usage={"tokens": 50}
        )
        ...
        assert (
            structured.structured_output.reasoning
            == "Generated from unstructured content"
        )
        assert (
            structured.structured_output.thought_process
            == "Processed unstructured content"
        )
...
class TestBaseLLMProviderStructuredMethods:
    ...
    async def test_generate_structured(self, mock_provider):
        ...
        result = await mock_provider.generate_structured(
            prompt="Test prompt", output_schema=AgentThinking
        )
    ...
    def test_create_structured_prompt(self, mock_provider):
        ...
        prompt = mock_provider._create_structured_prompt("Test prompt", AgentThinking)
    ...
    def test_create_structured_prompt_no_example(self, mock_provider):
        ...
        prompt = mock_provider._create_structured_prompt("Test prompt", NoExampleSchema)
