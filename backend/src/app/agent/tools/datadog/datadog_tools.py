...
class SearchLogsInput(BaseModel):
    ...
    time_from: Optional[str] = Field(
        default=None, description="Start time in ISO format (optional)"
    )
    time_to: Optional[str] = Field(
        default=None, description="End time in ISO format (optional)"
    )
...
class ListMonitorsInput(BaseModel):
    ...
    name_query: Optional[str] = Field(
        default="", description="Optional substring to filter monitor names"
    )
