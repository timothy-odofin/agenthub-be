...
class DatabaseError(ExternalServiceError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(message=message, service_name=database or "database", **kwargs)
...
class CacheError(ExternalServiceError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs["internal_details"] = internal_details
        super().__init__(message=message, service_name="redis", **kwargs)
...
class QueueError(ExternalServiceError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs["internal_details"] = internal_details
        super().__init__(message=message, service_name="queue", **kwargs)
...
class VectorDBError(ExternalServiceError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs["internal_details"] = internal_details
        super().__init__(message=message, service_name="vector_db", **kwargs)
...
class ThirdPartyAPIError(ExternalServiceError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs["internal_details"] = internal_details
        super().__init__(
            message=message, service_name=api_name or "third_party_api", **kwargs
        )
