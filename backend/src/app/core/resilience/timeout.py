...
def timeout(
    config: Optional[TimeoutConfig] = None, timeout_seconds: Optional[float] = None
) -> Callable:
    """
        ...
        def wrapper(*args, **kwargs) -> T:
            ...
            try:
                ...
                error_msg = (
                    ...
                    or f"Operation '{operation_name}' timed out after {config.timeout_seconds}s"
                )
    ...
    def decorator(func: Callable[..., T]) -> Callable[..., T]:
        ...
        async def wrapper(*args, **kwargs) -> T:
            ...
            try:
                ...
                error_msg = (
                    config.error_message
                    or f"Async operation '{operation_name}' timed out after {config.timeout_seconds}s"
                )
