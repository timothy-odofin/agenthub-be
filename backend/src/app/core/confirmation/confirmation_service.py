...
from app.core.confirmation.pending_actions_store import (
    PendingAction,
    PendingActionsStore,
)
...
class ConfirmationService:
    ...
    def __init__(self, store: PendingActionsStore, formatter: ActionPreviewFormatter):
        """
    ...
    async def confirm_action(self, action_id: str, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Action {action_id} execution failed: {e}", exc_info=True)
    ...
    async def cancel_action(self, action_id: str, user_id: str) -> Dict[str, Any]:
        """
    ...
    async def get_action_details(self, action_id: str, user_id: str) -> Dict[str, Any]:
        """
        ...
        if not action:
            logger.warning(
                f"Get details failed: Action {action_id} not found or expired"
            )
            raise ValueError(f"Action {action_id} not found or has expired")
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        return {**store_stats, "pending_executors": len(self._executors)}
