...
class SessionRepositoryRegistry:
    ...
    def get_repository_class(
        cls, repo_type: SessionRepositoryType
    ) -> Type[BaseSessionRepository]:
        ...
        if repo_type not in cls._repositories:
            ...
            raise ValueError(
                f"Session repository '{repo_type}' not found. Available: {available}"
            )
...
class SessionRepositoryFactory:
    ...
    def create_repository(
        repo_type: SessionRepositoryType, **kwargs
